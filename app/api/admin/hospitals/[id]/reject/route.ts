// app/api/admin/hospitals/[id]/reject/route.ts
...
export async function POST(
  ...
  try {
    ...
    hospital.rejectionReason = reason || 'Application rejected';
    ...
    console.log(`❌ Hospital ${hospital.hospitalName} rejected by admin ${decoded.userId}`);
