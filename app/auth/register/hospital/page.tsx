// app/auth/register/hospital/page.tsx
'use client';
...
export default function HospitalRegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-black dark:to-blue-950/30">
          ...
          <div className="p-8 max-h-[90vh] overflow-y-auto">
            <div className="text-center mb-8">
              <div className="flex justify-center mb-4">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-600 shadow-lg shadow-blue-200 dark:shadow-blue-900/30">
                  <Hospital className="h-8 w-8 text-white" />
                </div>
              </div>
              <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Register Hospital</h1>
              <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                Register your hospital to manage blood donations
              </p>
              <div className="mt-2 flex justify-center gap-4">
                <Link href="/auth/register/donor" className="text-sm px-4 py-1.5 bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-full hover:bg-zinc-300 dark:hover:bg-zinc-600 transition">
                  Donor
                </Link>
                <Link href="/auth/register/hospital" className="text-sm px-4 py-1.5 bg-blue-600 text-white rounded-full font-medium">
                  Hospital
                </Link>
              </div>
            </div>
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        disabled={isLoading}
                        className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition disabled:opacity-50 text-zinc-900 dark:text-white placeholder:text-zinc-400"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        required
                        disabled={isLoading}
                        className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition disabled:opacity-50 text-zinc-900 dark:text-white appearance-none"
                      >
                ...
                {/* Hospital Details */}
                <div className="space-y-4 border border-zinc-200 dark:border-zinc-700 rounded-lg p-4 bg-blue-50 dark:bg-blue-950/20">
                  <h3 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled={isLoading}
                      minLength={6}
                      className="w-full pl-10 pr-12 py-2.5 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition disabled:opacity-50 text-zinc-900 dark:text-white placeholder:text-zinc-400"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg transition shadow-lg shadow-blue-200 dark:shadow-blue-900/30 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isLoading ? (
                    <>
            ...
            <div className="relative mt-8">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-4 bg-white dark:bg-zinc-900 text-zinc-400 dark:text-zinc-500">
                  Join the RedPulse Healthcare Network
                </span>
              </div>
            </div>
          </div>
