  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setTimeout(() => {
          // Redirect to donors dashboard instead of user dashboard
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-4 border border-zinc-200 dark:border-zinc-700 rounded-lg p-4 bg-zinc-50 dark:bg-zinc-800/30">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-1">Must be at least 18 years old</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-1">Must be at least 50 kg</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        disabled={isLoading}
                        rows={2}
                        className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition disabled:opacity-50 text-zinc-900 dark:text-white placeholder:text-zinc-400 resize-none"
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-1">Must be at least 6 characters</p>
                </div>
